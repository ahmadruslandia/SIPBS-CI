                            ...
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        <label>Judul</label>
                                        <input type="text" name="title" value="<?php echo $b['post_title']; ?>" class="form-control" placeholder="Judul" required>
                                    </div>
                                    <div class="form-group">
                            ...
                            <div class="panel panel-white">
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" cols="6" rows="6" class="form-control" placeholder="Meta Deskripsi"><?php echo $b['post_description']; ?></textarea>
                                    </div>
