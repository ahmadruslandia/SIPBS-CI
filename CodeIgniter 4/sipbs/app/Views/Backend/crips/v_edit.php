                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control" name="kode_criteria">
                                                <option></option>
                                                <?= \App\Helpers\get_criteria_option(set_value('kode_criteria', $rowl['kode_criteria'])) ?>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" type="text" name="nama_crips" value="<?= set_value('nama_crips', $rowl['nama_crips']) ?>" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">Nilai</label>
                                        <div class="col-sm-10">
                                            <input class="form-control" type="text" name="nilai" value="<?= set_value('nilai', $rowl['nilai']) ?>" />
                                        </div>
                                    </div>
                                    <div class="form-group">
