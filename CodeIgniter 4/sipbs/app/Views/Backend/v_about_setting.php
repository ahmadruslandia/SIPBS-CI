...
<body class="page-header-fixed  compact-menu  pace-done page-sidebar-fixed">
    ...
    <main class="page-content content-wrap">
                    ...
                    <?php if (session()->get('access') == '1') : ?>
                        ...
                        <li class="droplink active open"><a href="<?php echo site_url('backend/settings'); ?>" class="waves-effect waves-button"><span class="menu-icon icon-settings"></span>
                            ...
                            <ul class="sub-menu">
                                ...
                                <li class="active"><a href="<?php echo site_url('backend/aboutsetting'); ?>">Tentang</a></li>
        ...
        <div class="page-inner">
            ...
            <div id="main-wrapper">
                <div class="row">
                    <form class="form-horizontal" action="<?php echo base_url() . 'backend/aboutsetting/update' ?>" method="post" enctype="multipart/form-data">
                        <div class="col-md-12">
