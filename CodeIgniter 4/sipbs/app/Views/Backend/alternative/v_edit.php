                                ...
                                <div class="panel-body">
                                    ...
                                    <form method="post">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" name="kode_alternative" value="<?= set_value('kode', $rowl->kode_alternative) ?>" readonly="" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Nama Alternatif</label>
                                            <div class="col-sm-10">
                                                <input class="form-control" name="nama_alternative" value="<?= set_value('nama_alternative', $rowl->nama_alternative) ?>" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Keterangan</label>
                                            <div class="col-sm-10">
                                                <input class="form-control" name="keterangan" value="<?= set_value('keterangan', $rowl->keterangan) ?>" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Alamat</label>
                                            <div class="col-sm-10">
                                                <input class="form-control" name="alamat" value="<?= set_value('alamat', $rowl->alamat) ?>" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Nama Pengelola</label>
                                            <div class="col-sm-10">
                                                <input class="form-control" name="nama_pengelola" value="<?= set_value('nama_pengelola', $rowl->nama_pengelola) ?>" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Nomor Telepon</label>
                                            <div class="col-sm-10">
                                                <input class="form-control" name="nomor_telepon" value="<?= set_value('nomor_telepon', $rowl->nomor_telepon) ?>" />
                                            </div>
                                        </div>
                                        <div class="form-group">
