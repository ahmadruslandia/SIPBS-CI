                                    ...
                                    <form method="post">
                                        <?php foreach ($rows as $row) : ?>
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label"><?= $row->nama_criteria ?> <span class="text-danger">*</span></label>
                                                <div class="col-sm-10">
                                                    <select class="form-control" name="kode_crips[<?= $row->ID ?>]">
                                                        <option value="">&nbsp;</option>
                                                        <?= \App\Helpers\get_crips_option($row->kode_criteria, set_value("kode_crips[$row->ID]", $row->kode_crips)) ?>
                                                    </select>
                                                </div>
                                            </div>
                                        <?php endforeach ?>
