                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-striped table-hover">
                                            ...
                                            <?php foreach ($rel_alternative as $key => $val) : ?>
                                                <tr>
                                                    <td><?= esc($key) ?></td>
                                                    <td><?= isset($alternative[$key]->nama_alternative) ? esc($alternative[$key]->nama_alternative) : "-" ?></td>
                                                    <?php foreach ($val as $k => $v) : ?>
                                                        <td><?= isset($crips[$v]['nama_crips']) ? esc($crips[$v]['nama_crips']) : "-" ?></td>
                                                    <?php endforeach ?>
                                                </tr>
                                            <?php endforeach ?>
                                        </table>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-striped table-hover">
                                        ...
                                        <?php foreach ($topsis->rank as $key => $val) :
                                            \App\Helpers\query("UPDATE tb_alternative SET total_topsis='{$topsis->pref[$key]}', rank_topsis='$val' WHERE kode_alternative='$key'");
                                        ?>
                                            <tr>
                                                <td><?= $key ?></td>
