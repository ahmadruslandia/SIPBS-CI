                            ...
                            <div class="panel-body">
                                ...
                                <form class="form-horizontal" method="post" enctype="multipart/form-data">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" type="text" name="kode" value="<?= set_value('kode', \App\Helpers\kode_oto('kode_criteria', 'tb_criteria', 'C', 2)) ?>" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control" name="atribut">
                                                <option></option>
                                                <?= \App\Helpers\get_atribut_option(set_value('atribut')) ?>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
