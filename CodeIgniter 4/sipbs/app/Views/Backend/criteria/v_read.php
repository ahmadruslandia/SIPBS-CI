...
<body class="page-header-fixed compact-menu pace-done page-sidebar-fixed">
                                            ...
                                            <div class="col-md-12">
                                                <form class="form-inline">
                                                    <?php if (session()->get('access') == '1') : ?>
                                                        ...
                                                        <div class="form-group">
                                                            <a class="btn btn-default" target="_blank" href="<?= site_url('Backend/criteria/cetak?search=' . request()->getGet('search')) ?>"><span class="glyphicon glyphicon-print"></span> Cetak</a>
                                                        </div>
                                                    <?php else: ?>
                                                    <?php endif; ?>
                                                </form>
    ...
    <?php if (session()->getFlashdata('msg') == 'success') : ?>
        <script type="text/javascript">
            $.toast({
                heading: 'Success',
                text: "Kriteria Berhasil Di Tambah!",
    ...
    <?php elseif (session()->getFlashdata('msg') == 'success-ubah') : ?>
        <script type="text/javascript">
            $.toast({
                heading: 'Success',
                text: "Kriteria Berhasil Di Ubah!",
                showHideTransition: 'slide',
                icon: 'success',
                hideAfter: false,
                position: 'bottom-right',
    ...
    <?php elseif (session()->getFlashdata('msg') == 'success-hapus') : ?>
        <script type="text/javascript">
            $.toast({
                heading: 'Success',
                text: "Kriteria Berhasil Di Hapus!",
                showHideTransition: 'slide',
                icon: 'success',
                hideAfter: false,
                position: 'bottom-right',
