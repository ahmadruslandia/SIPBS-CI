                ...
                <ul class="menu accordion-menu">
                    <li class="droplink active open"><a href="#" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-home"></span>
                        ...
                        <ul class="sub-menu">
                            ...
                            <li class="active"><a href="<?php echo site_url('backend/system'); ?>">Sistem</a></li>
                        </ul>
                    </li>
            ...
            <div id="main-wrapper">
                        ...
                        <div class="panel info-box panel-white">
                            <div class="panel-body">
                                <div class="info-box-stats">
                                    ...
                                    <span class="info-box-title">Pengunjung</span>
                                </div>
                        ...
                        <div class="panel info-box panel-white">
                            <div class="panel-body">
                                <div class="info-box-stats">
                                    ...
                                    <span class="info-box-title">Halaman Dilihat</span>
                                </div>
                                <div class="info-box-icon">
                                    <i class="icon-eye"></i>
                                </div>
                        ...
                        <div class="panel info-box panel-white">
                            <div class="panel-body">
                                <div class="info-box-stats">
                                    ...
                                    <span class="info-box-title">Seluruh Berita</span>
                                </div>
                                <div class="info-box-icon">
                        ...
                        <div class="panel info-box panel-white">
                            <div class="panel-body">
                                <div class="info-box-stats">
                                    ...
                                    <span class="info-box-title">Seluruh Komen</span>
                                </div>
                                <div class="info-box-icon">
                ...
                <div class="row">
                            ...
                            <div class="row">
                                <div class="col-sm-8">
                                    <div class="visitors-chart">
                                        <div class="panel-heading">
                                            <h4 class="panel-title">Pengunjung Bulan ini</h4>
                                        </div>
                                        <div class="panel-body">
                                            <div class="col-md-12">
                                ...
                                <div class="col-sm-4">
                                    <div class="stats-info">
                                        <div class="panel-heading">
                                            <h4 class="panel-title">Status Browser</h4>
                                        </div>
                                        <div class="panel-body">
                                            <ul class="list-unstyled">
                                                ...
                                                <li>Lainnya<div class="text-success pull-right"><?php echo number_format($other_visitor, 2); ?>%</div>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="panel panel-white">
                            <div class="panel-heading">
                                <h4 class="panel-title">5 Top Berita</h4>
                            </div>
                            <div class="panel-body">
                                    ...
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>Judul Berita</th>
                                                <th style="text-align: right;">Dilihat</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php
                                            $no = 0;
                                            foreach ($top_five_articles as $row) :
                                                $no++;
                                            ?>
                                                <tr>
