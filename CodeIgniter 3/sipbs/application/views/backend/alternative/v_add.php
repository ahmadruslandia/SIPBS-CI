                    ...
                    <div class="col-md-12">
                        <div class="panel panel-white">
                            ...
                            <div class="panel-body">
                                ...
                                <form class="form-horizontal" action="<?php echo base_url() . 'backend/alternative/tambah' ?>" method="post" enctype="multipart/form-data">
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">Kode Alternatif</label>
                                        <div class="col-sm-10">
                                            <input class="form-control" type="text" name="kode_alternative" value="<?= set_value('kode_alternative', kode_oto('kode_alternative', 'tb_alternative', 'A', 2)) ?>" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">Nama Alternatif</label>
                                        <div class="col-sm-10">
                                            <input class="form-control" type="text" name="nama_alternative" value="<?= set_value('nama_alternative') ?>" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" type="text" name="nama_pengelola" value="<?= set_value('nama_pengelola') ?>" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">Nomor Telepon</label>
                                        <div class="col-sm-10">
                                            <input class="form-control" type="text" name="nomor_telepon" value="62<?= set_value('nomor_telepon') ?>" />
                                        </div>
                                    </div>
                                    <div class="form-group">
