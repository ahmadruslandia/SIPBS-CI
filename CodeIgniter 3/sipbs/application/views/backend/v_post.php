                ...
                <ul class="menu accordion-menu">
                    ...
                    <li class="droplink active open"><a href="#" class="waves-effect waves-button"><span class="menu-icon icon-pin"></span>
                        ...
                        <ul class="sub-menu">
                            ...
                            <li class="active"><a href="<?php echo site_url('backend/post'); ?>">List Berita</a></li>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-white">
                            <div class="panel-body">
                                <a href="<?php echo site_url('backend/post/add_new'); ?>" class="btn btn-success m-b-sm">Tambah</a>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="alert alert-info">
                            Anda yakin mau menghapus berita ini?
                        </div>
                    </div>
