                ...
                <ul class="menu accordion-menu">
                    ...
                    <?php if ($this->session->userdata('access') == '1'): ?>
                        ...
                        <li class="droplink active open"><a href="<?php echo site_url('backend/settings'); ?>" class="waves-effect waves-button"><span class="menu-icon icon-settings"></span>
                            ...
                            <ul class="sub-menu">
                                <li class="active"><a href="<?php echo site_url('backend/settings'); ?>">Site</a></li>
                            ...
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        <label for="input1" class="col-sm-2 control-label">Nama Site</label>
                                        <div class="col-sm-10">
                                    ...
                                    <div class="form-group">
                                        <label for="input1" class="col-sm-2 control-label">Judul Site</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="title" class="form-control" id="input1" value="<?php echo $site_title; ?>" placeholder="Site Title">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="input1" class="col-sm-2 control-label">Deskripsi Site</label>
                                        <div class="col-sm-10">
