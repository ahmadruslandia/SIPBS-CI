                                            ...
                                            <div class="col-md-12">
                                                <form class="form-inline">
                                                    <div class="form-group <?= ($this->session->userdata('level') == 'admin') ?>">
                                                        <a class="btn btn-default" target="_blank" href="<?= site_url('backend/calculation/hasil_cetak?search=' . $this->input->get('search')) ?>"><span class="glyphicon glyphicon-print"></span> Cetak</a>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
